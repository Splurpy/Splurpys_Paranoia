...
public class PlayerSanityProvider  implements ICapabilityProvider, INBTSerializable<CompoundTag> {
    ...
    public static Capability<PlayerSanity> PLAYER_SANITY = CapabilityManager
            .get(new CapabilityToken<PlayerSanity>() {
    });
    ...
    public CompoundTag serializeNBT() {
        ...
        createPlayerSanity().saveNBT(tag);
    ...
    public void deserializeNBT(CompoundTag tag) {
        createPlayerSanity().loadNBT(tag);
    }
}
